...
namespace Camera_NET
{
    ...
    public class Camera : IDisposable
    {
        ...
        private static void AnalyzeMediaType(AMMediaType media_type, Resolution resolution_desired, out bool bit_count_ok, out bool sub_type_ok, out bool resolution_ok)
        {
            ...
            // ---------------------------------------------------
            bool whatType1 = media_type.subType == MediaSubType.RGB32;
            bool whatType2 = media_type.subType == MediaSubType.ARGB32;
            bool whatType3 = media_type.subType == MediaSubType.RGB24;
            bool whatType4 = media_type.subType == MediaSubType.RGB16_D3D_DX9_RT;
            bool whatType5 = media_type.subType == MediaSubType.YUY2;
        ...
        private void GraphBuilding_ConnectPins()
        {
            ...
            try
            {
                ...
                // Praveen Below code also works but creates a seperate window
                //hr = DX.FilterGraph.Render(pinSourceCapture);
